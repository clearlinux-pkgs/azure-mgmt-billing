...
Source0  : https://files.pythonhosted.org/packages/ed/53/79afdd87c1c117835554582a3e0ed835d49bd862f931ac38b29c9e18749f/azure-mgmt-billing-1.0.0.zip
...
%prep
%setup -q -n azure-mgmt-billing-1.0.0
cd %{_builddir}/azure-mgmt-billing-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608045647
